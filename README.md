...
## MouthScan Variant: Mouth RGB -> Joint

This branch adapts RISE to predict the next joint configuration from mouth RGB images.
...
- Train entrypoint: `train_mouthscan.py` with `INPUT_TYPE=mouth_rgb`, `TARGET_TYPE=joint`
...
torchrun --nproc_per_node 1 --nnodes 1 --node_rank 0 train_mouthscan.py \
  ...
  --ckpt_dir logs/mouthscan_rgb_joint
```
